...
export default function FreelancerDashboard() {
  ...
  const statCards = [
    ...
    { label: 'Balance', value: formatCurrency(data.totalEarnings), icon: DollarSign, color: 'text-cyan-400', bg: 'bg-cyan-500/10' },
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="glass-card rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <Link href="/dashboard/freelancer/projects" className="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-cyan-600/20 to-sky-600/20 border border-cyan-500/30 hover:border-cyan-400/50 transition-all group">
            <div className="p-2 bg-cyan-500/20 rounded-lg">
      ...
      <div className="glass-card rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/dashboard/freelancer/projects" className="text-sm text-cyan-400 hover:text-cyan-300 flex items-center gap-1">
